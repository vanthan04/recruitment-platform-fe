    ...
    <div className="mx-auto max-w-3xl px-4 py-10">
      ...
      <div className="space-y-4">
        {cvs.map((cv) => (
          <div
            key={cv.id}
            className="border-border flex flex-wrap items-center justify-between gap-3 rounded-xl border p-4 shadow-sm"
          >
            <div>
              ...
              <div className="mt-1.5">
                <Badge variant={cv.status === "PUBLISHED" ? "default" : "secondary"} className="rounded-full">
